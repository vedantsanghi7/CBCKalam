...
SLOT_QUESTIONS = {
    ...
    "occupation": {"question": "What is your occupation?",
                   "options": ["Farmer / किसान", "Laborer / मज़दूर", "Vendor / दुकानदार", "Salaried / नौकरी", "Business / व्यापार", "Other / अन्य"]},
    "district_rural_or_urban": {"question": "Do you live in a rural or urban area?",
    ...
    "annual_income_inr": {"question": "What is your annual income?",
                          "options": ["< ₹50,000", "₹50,000 - ₹2,00,000",
    ...
    "land_ownership_type": {"question": "Do you own land, lease it, or have no land?",
                            "options": ["Own land / अपनी ज़मीन", "Leased / पट्टे पर", "No land / कोई ज़मीन नहीं"]},
    "income_tax_filed_last_ay": {"question": "Did you file income tax last year?",
                                 "options": ["Yes / हाँ", "No / नहीं"]},
    "monthly_pension_inr": {"question": "Do you receive a pension?",
                            "options": ["No pension / कोई पेंशन नहीं", "< ₹10,000", "₹10,000+"]},
    "is_bpl": {"question": "Are you BPL (Below Poverty Line)?",
    ...
    "is_pregnant": {"question": "Are you pregnant or have recently delivered?",
                    "options": ["Yes / हाँ", "No / नहीं"]},
    "has_daughter_under_10": {"question": "Do you have a daughter under 10?",
                              "options": ["Yes / हाँ", "No / नहीं"]},
    "is_disabled": {"question": "Are you disabled (Divyang)?",
                    "options": ["Yes / हाँ", "No / नहीं"]},
    "govt_employee_status": {"question": "Are you a government employee?",
                             "options": ["No / नहीं", "Serving / सेवारत", "Retired / सेवानिवृत्त"]},
}
